...
void updateTimer(volatile Timer *t) // Update 7-segment display with current timer value
{
    *DISPLAY_ADDR(5) = 0xFF;
    *DISPLAY_ADDR(4) = 0xFF;
...
void tick(volatile Timer *t, int increment) // Increment or decrement timer by specified seconds
{
...
void startTimer() // Start the hardware timer
{
...
void stopTimer() // Stop the hardware timer
{
